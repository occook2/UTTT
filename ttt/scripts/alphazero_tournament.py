...
from ttt.eval.tournaments import play_series_with_records, save_series_json
...
from ttt.agents.az.train import TrainingConfig
...
def run_alphazero_vs_baseline(
    ...
    output_dir: str = "ttt/tournaments",
) -> str:
    """
...
def list_available_checkpoints(checkpoint_dir: str = "ttt/checkpoints"):
...
def main():
    ...
    list_parser.add_argument('--checkpoint-dir', default='ttt/checkpoints', 
    ...
    baseline_parser.add_argument('--baseline', choices=['random'], 
    ...
    baseline_parser.add_argument('--output-dir', default='ttt/tournaments', help='Output directory')
    ...
    az_parser.add_argument('--simulations', type=int, default=100, 
                          help='MCTS simulations per move')
    az_parser.add_argument('--output-dir', default='ttt/tournaments', help='Output directory')
