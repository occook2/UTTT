...
from ttt.agents.az.net import AlphaZeroNetTTT
from ttt.mcts.alphazero_strategy import AlphaZeroStrategy
...
class AlphaZeroAgent(Agent):
    ...
    def __init__(
        self, 
        network: Optional[AlphaZeroNetTTT] = None,
    ...
    def evaluate_position(self, env: TTTEnv) -> float:
        """
