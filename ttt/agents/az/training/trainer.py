...
from ttt.agents.az.net import AlphaZeroNetTTT, AZNetConfig
from ttt.agents.az.loss import AlphaZeroLoss
from ttt.agents.az.self_play import SelfPlayTrainer, TrainingExample
from ttt.agents.az.symmetry import augment_examples_with_rotations
from ttt.mcts.base import MCTSConfig
...
class AlphaZeroTrainer:
    ...
    def __init__(self, config: TrainingConfig, run_dir: str = None):
        ...
        self.network = AlphaZeroNetTTT(net_config)
