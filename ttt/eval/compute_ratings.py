...
from ttt.eval.elo import EloTable
...
def main():
    ...
    p.add_argument("--runs_dir", default="ttt/tournaments", help="Directory with series_*.json files")
    p.add_argument("--ratings_out", default="ttt/tournaments/elo_ratings.json", help="Path to write Elo table")
