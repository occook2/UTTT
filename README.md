...
This project demonstrates a complete AlphaZero implementation with:
- Clean, modular architecture
- Comprehensive evaluation tools  
- Rich debugging and visualization capabilities
- Production-ready training pipeline

Feel free to experiment with different architectures, hyperparameters, or game variants!

## Documentation

For more detailed information, see the `docs/` directory:
- [Training Guide](docs/TRAINING_GUIDE.md) - Detailed training instructions
- [Tournament Guide](docs/TOURNAMENT_GUIDE.md) - Tournament and evaluation guide
