...
def main():
    ...
    p.add_argument("--runs_dir", default="uttt/tournaments", help="Directory with series_*.json files")
    p.add_argument("--ratings_out", default="uttt/tournaments/elo_ratings.json", help="Path to write Elo table")
